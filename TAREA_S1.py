#Nombre: PIEDRA JIMÉNEZ BRYAN SAMUEL
#Tarea de ejercicios (clases y objetos, funciones)
...
class Operaciones:
    ...
    def operaciones(self):
        ...
        print ("el resultado de la multiplicacion es:{}" .format(c)) 
        print ("el resultado de la division es: {}".format(d))
        print ("el resultado del modulo es:{}".format(e))

     #Resolver la hipotenusa
    def hipotenusa(self):
        numero1 = int(input("Ingresar un numero1 : "))
        numero2 = int(input("Ingresar el numero2 : "))
        h= ((numero1)^2 + (numero2)^2)**0.5
        print('la hipotenusa calculada es : ',h)

     # Resolver la resolvente
    def resolvente(self):
        numero1=int(input("Ingrese n1 :"))
        numero2=int(input("Ingrese n2 :"))
        num3=int(input("Ingrese n3 :"))
    ...
    def paridadEimparidad(self):
        numero1 = int(input("Ingresar un num: "))
        if numero1 % 2 == 0:
            x4 = "0 par"
            print('el resulado es:', x4)
        else:
            x5 = "1 impar" 
            print('el resulado es:', x5)
    ...
    def bitParidad(self):
        binario = int(input("Ingesar un numero binario de 4 digitos:"))
        bit1 = int(binario[0])
        bit2 = int(binario[1])
        bit3 = int(binario[2])
        bit4 = int(binario[3])
    ...
    def nombreCiudad(self):
        for i in range (4):
            ciudad_1 = input("Ingrese primera ciudad: ")
    ...
    def MillasAkilometro(ciudad):
        ...
        #La entrada vendrá dada por dos enteros positivos el primero repres   
